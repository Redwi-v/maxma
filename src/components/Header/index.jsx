	...
	return (
		<header className={"header"}>
			<div className={"header__left"}>
				{(windowWidth > 565 ||
					(windowWidth <= 565 && !openMobileMenuModules && !openMobileMenuIntegrations)) && (
					...
					{!openMobileMenuModules && !openMobileMenuIntegrations && (
						<>
							<div className={"header__right-menu-box"}>
								...
								<div
									onClick={() => setOpenMobileMenuModules(true)}
							...
							<div className={"header__right-menu-socials"}>
								...
								>
									...
									<span className={"header__right-menu-socials-social-text"}>
										hello@maxma.com
									</span>
								</div>
						...
						<>
							...
							<div className={"header__right-menu-itemsModules"}>
								{[
									...
									.map(({ icon, title, text }) => (
										<div className={"header__menu-modules-items-item"}>
								...
								{[
									...
									>
										...
										<div className={"header__menu-integrations-items-item-box"}>
											<h6 className={"header__menu-integrations-items-item-box-title"}>
												{title}
											</h6>
											<p className={"header__menu-integrations-items-item-box-text"}>
												{text}
											</p>
										</div>
									</div>
					...
					<div className={"header__menu-modules"}>
						...
						<div className={"header__menu-modules-items"}>
							{[
								...
								.map(({ icon, title, text }) => (
									<div className={"header__menu-modules-items-item"}>
										<div className={"header__menu-modules-items-item-icon"}>
											<img width={32} height={32} src={`/img/header-menu-icons/${icon}.svg`} alt={"Иконка модуля"} />
										</div>
										<h6 className={"header__menu-modules-items-item-title"}>{title}</h6>
										<p className={"header__menu-modules-items-item-text"}>{text}</p>
									</div>
						...
						<button
							...
							onClick={() => {
								...
								console.log(itemsForShowPlatformMenu !== 10);
					...
					<div className={"header__menu-integrations"}>
						...
						<div className={"header__menu-integrations-items"}>
							{[
								...
								<div className={"header__menu-integrations-items-item"}>
									<div className={"header__menu-integrations-items-item-icon"}>
										<img width={22} height={22} src={`/img/header-menu-icons/${icon}.svg`} alt={"Иконка интеграций"} />
									</div>
									<div className={"header__menu-integrations-items-item-box"}>
