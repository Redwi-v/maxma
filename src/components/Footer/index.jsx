        ...
        <footer className={'footer'}>
            <div className="footer__content">
                <div className="footer__content-top">
                    ...
                    <ul
                        className={clsx('footer__content-top-nav', {
                            'display-none': windowWidth > 700,
                        })}
                    >
                        {['Продукт', 'Информация', 'Модули', 'Maxma'].map((item, index) => (
                            <li className={'footer__content-top-nav-item'} key={index}>
                ...
                <div className="footer__content-center">
                    {[
                        ...
                        <nav
                            key={links}
                            className={clsx('footer__content-center-menu', {
                                'display-none': windowWidth <= 700,
                            })}
                        >
                            ...
                            <div className="footer__content-center-menu-links">
                                {links.map((link) => (
                                    <a className={'footer__content-center-menu-links-link'} href={'#'} key={link}>
                                        {link}
                                    </a>
                                ))}
                            </div>
