...
function EmailForm({ windowWidth, buttonText, formSendedCallBack }) {
    ...
    return (
        <div className={clsx('cost__box-left-extra', styles.form_wrapper)}>
            {
                formIsOpen ?

                    <div className={styles.email_form}>
                        <Input windowWidth={windowWidth} buttonText={buttonText} placeholder='Ваш e-mail' value={value} setValue={setValue}
                            status={status}
                            onClick={onClick}
                        />
                        ...
                        {
                            status === 'err' && <p className={clsx('err', styles.err)}>{
                    ...
                    : <div className={clsx('cost__box-left-extra', styles.form_preview)}>
                        <div className="cost__box-left-extra-notion">
                            <Icon
                                ...
                                height={28}
                            />
                            <p className="cost__box-left-extra-notion-text">
                                Отправим полный расчет на e-mail
                            </p>
                        </div>
